...
var internationalizeButton = '<button id="internationalize">Internationalize</button>'; // I added an ID so function can work only with this button
var googleMap = '<div id="map"></div>';

var HTMLnavbarDiv = '<div class="container"></div>'
var HTMLnavbarTags = '<nav class="navbar navbar-toggleable-md navbar-light orange fixed-top"></nav>';
...
$(document).ready(function() {
  $('button#internationalize').click(function() {   //ID added
    var $name = $('#name');
